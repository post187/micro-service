...
import com.example.Exception.ResourceExistedException;
...
public class RatingService {
    ...
    public RatingVm createRating(RatingPostVm ratingPostVm) throws AccessDeniedException {
    ...
    public ResponseStatusVm deleteRating(long ratingId) {
        Rating rating = ratingRepository.findById(ratingId)
                .orElseThrow(() -> new NotFoundException(Constants.ErrorCode.RATING_NOT_FOUND, ratingId));

        ratingRepository.delete(rating);
        return new ResponseStatusVm("Delete Rating", Constants.Message.SUCCESS_MESSAGE, HttpStatus.OK.toString());
    }
