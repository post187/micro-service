...
public class OrderController {
    ...
    public ResponseEntity<Mono<OrderDto>> findById(@PathVariable("orderId")
        ...
        return ResponseEntity.ok(orderService.findById(Long.parseLong(orderId)));
    }
    ...
    public Mono<ResponseEntity<OrderDto>> update(@PathVariable("orderId")
        ...
        return orderService.update(Long.parseLong(orderId), orderDto)
                .map(ResponseEntity::ok)
                .defaultIfEmpty(ResponseEntity.notFound().build());
    }
    ...
    public Mono<ResponseEntity<Boolean>> deleteById(@PathVariable("orderId") final String orderId) {
        ...
        this.orderService.deleteById(Long.parseLong(orderId));
        return orderService.deleteById(Long.parseLong(orderId))
