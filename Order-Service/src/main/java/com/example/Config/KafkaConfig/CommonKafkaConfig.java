...
public class CommonKafkaConfig {
    ...
    KafkaSender<String,String> kafkaSender(){
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, reactiveKafkaProperties.bootstrapServers);
    ...
    ReceiverOptions<String,String> receiverOptions(){
        ...
        propsReceiver.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, reactiveKafkaProperties.bootstrapServers);
        propsReceiver.put(ConsumerConfig.GROUP_ID_CONFIG, reactiveKafkaProperties.consumerGroupId);
